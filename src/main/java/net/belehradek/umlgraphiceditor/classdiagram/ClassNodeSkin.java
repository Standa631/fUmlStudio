package net.belehradek.umlgraphiceditor.classdiagram;
...
import net.belehradek.umlgraphiceditor.GNodeSkinFix;
...
public class ClassNodeSkin extends GNodeSkinFix {
    ...
    public ClassNodeSkin(final GNode node) {
        ...
        addAttribuet("attribute1");
        addAttribuet("attribute2");
        addAttribuet("attribute3");
        addAttribuet("attribute4");
        addAttribuet("attribute5");
        addAttribuet("attribute6");
        addOperation("addIt");
    }
    ...
    public void initialize() {
        super.initialize();
        title.setText("Class " + getNode().getId());
    }
